...
EXCEL_PROMPT = (
    ...
    "ДҮГНЭЛТИЙН БҮТЭЦ:\n\n"
    "1. ЕРӨНХИЙ ТОЙМ: Нийт ажилтнуудын тестийн үр дүнгийн ерөнхий байдал,дундаж оноо, давуу болон сул талуудыг товч дүгнэ.\n\n"
    "2. ТЕСТ ТУС БҮРИЙН ДҮГНЭЛТ: **CTPI**, **Big5**, **EQ**, **VOC**, **PP Test**, "
    "**MOTIVATION+** тест тус бүрийн үр дүнг дүгнэхдээ тухайн тестийн хэмждэг үндсэн үзүүлэлт,ур чадварын үзүүлэлт тус бүр дэхь оноо, тжс оноог харьцуулсан дүн шинжилгээг хийх. Аль ур чадвар дээр байгууллага нийтээрээ жигд өндөр эсвэл харилцан адилгүй ялгаатай оноотой байгааг харьцуулж хамгийн өнлөр болон бага оноотой үр дүнг харьцуулж хөгжлийн боломжийг үзүүлэлт тус бүртэй уялдуулан тодорхойл.\n"
    "тэдний хөгжлийн боломжийг тодорхойл.\n\n"
    "3. ОНЦЛОХ АЖИЛТНУУД: Олон үзүүлэлтээр өндөр оноотой   talent ажилтнууд болон "
    "хөгжүүлэх шаардлагатай ажилтнуудыг тодорхойлж, шалтгааныг тайлбарла.\n\n"
    "4. ХӨГЖҮҮЛЭХ ЗӨВЛӨМЖ: Байгууллагат зориулсан тодорхой, "
    ...
    "talent-ыг хэрхэн хөгжүүлэх, тохиромжтой албан тушаалд байршуулах, "
