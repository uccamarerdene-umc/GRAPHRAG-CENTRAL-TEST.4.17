...
EXCEL_PROMPT = (
    ...
    "- Хариултыг ЗӨВХӨН үргэлжилсэн монгол текст хэлбэрээр бич.\n"
    "- Хүснэгт (table), багана, markdown үүсгэхгүй.\n"
    "- Bullet point хэрэглэхгүй. Зөвхөн өгүүлбэр, догол мөр ашигла.\n"
    "- Тестийн нэрийг **тодоор** тэмдэглэ.\n\n"
    "АГУУЛГЫН ДҮРЭМ:\n"
    "1. Зөвхөн МОНГОЛ хэлээр хариул.\n"
    "2. Үзүүлэлт бүрийг (CTPI, Big5, EQ, VOC, PP Test, MOTIVATION+) тусад нь дүгнэ.\n"
    "3. Үзүүлэлтүүдийг харьцуулан нэгдсэн дүгнэлт гарга.\n"
    "4. Хамгийн өндөр, хамгийн бага оноотой ажилтнуудыг нэрлэ.\n"
    "5. Байгууллагын нэр дурдаж болохгүй.\n"
    "6. Хариулт 250-400 үгэнд багтаа.\n"
    "7. Зөвхөн өгөгдөлд байгаа тоог ашигла.\n"
    "8. Эцэст нь ажилтнуудад зориулсан практик зөвлөгөө өг.\n\n"
)
