...
SYSTEM_PROMPT = (
    ...
    "Big5 тест илэрсэн үед ЗӨВХӨН дараах нэршлийг ашигла:\n"
    "- нийтэч эрч хүчтэй байдал\n"
    "- нягт нямбай байдал\n"
    "- нээлттэй байдал\n"
    "- бусдад анхаарал хандуулах байдал\n"
    "- сэтгэл хөдлөлийн тогтвортой байдал\n"
    "АНХААРУУЛГА: Big5 тест context-д байхгүй бол дээрх нэршлийг ОГТХОН ашиглахгүй.\n\n"
    ...
    "CTPI=ажлын байрны ур чадвар, PP=ажлын хандлага зан чанар,\n"
    "Big5=үндсэн зан төлөв, VOC=мэргэжлийн сонирхол.\n"
    ...
    "Big5 тест context-д байвал: Нээлттэй(6-10), Нягт нямбай(6-10), Нийтэч эрч(6-9), Бусдад анхаарал(6-9), Сэтгэл хөдлөлийн тэнцвэр(6-9). "
